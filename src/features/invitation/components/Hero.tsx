...
export const Hero = () => {
  ...
  return (
    <section className="relative h-screen w-full flex flex-col overflow-hidden bg-stone-950">
      ...
      {/* 2. Efecto de Nieve (Capa intermedia) */}
      <SnowEffect />
      ...
      <div className="relative z-10 flex flex-col h-full w-full p-6">
        ...
        >
          <div className="max-w-[80%]">
            <h1
              className={`${alexBrush.className} text-5xl md:text-8xl text-amber-100 text-center leading-none drop-shadow-[0_2px_15px_rgba(0,0,0,0.9)]`}
            >
              Mis XV Años
            </h1>
          </div>
        ...
        >
          <h2
            className={`${playfair.className} text-2xl md:text-5xl tracking-[0.3em] text-white uppercase text-center drop-shadow-lg`}
          >
            {VALERIA_DATA.name}
          </h2>
      ...
      <div
        ...
        className="absolute inset-4 border border-white/10 pointer-events-none z-20"
      />
    </section>
  );
};